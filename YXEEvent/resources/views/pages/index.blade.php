    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('all_events') }}">All Events</a>
          </li>
          <li class="nav-item">
                ...
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <p class="intro-subtitle intro-price">
                      <a href="all_events.html"><span class="price-a">View Events</span></a>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            ...
            <div class="title-link">
              <a href="property-grid.html">All Events
              ...
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single.html">Halloween
                      <br /> Party </a>
                  </h2>
                </div>
          ...
          <div class="card-box-a card-shadow">
            ...
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single.html">Diwali <br> Party</a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
          ...
          <div class="card-box-a card-shadow">
            ...
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single.html">All Night
                      <br /> Party</a>
                  </h2>
                </div>
                <div class="card-body-a">
          ...
          <div class="card-box-a card-shadow">
            ...
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single.html"> Afrobeats <br> Party </a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
